	subroutine v0_f_c2a2(L, n_k, dn_dt, V_q, V_q_dependent, rta)
	integer L
    ...
    integer m3x,m3y,m3z
    integer m4x,m4y,m4z, m1xy, factor, qx,qy,qz
	...
	!$omp  & m3x,m3y,m3z, m4x,m4y,m4z, n3,n4,e3,e4, term, qx,qy,qz, V_sqr )
	do m1z = -L2, L2-1
    do m1y = -L2, L2-1
	do m1x = -L2, L2-1
